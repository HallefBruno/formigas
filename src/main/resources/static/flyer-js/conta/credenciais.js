        ...
        $.ajax({
            ...
            statusCode: {
                ...
                200: function (data, textStatus, jqXHR) {
                    ...
                    $(".tab-content").html(htmlEscolhaDoCondominio());
...
function htmlDadosCadastrais() {
    return "<div class='container-fluid col-sm-6' style='margin-top: 50px;'>"+
        ...
        "<div class='panel-body'>"+
            "<form th:action='@{/criarconta/save}' method='post'>"+
                ...
                "<div class='form-group' style='text-align: right;'>"+
                    "<button type='button' onclick='criarConta();' class='btn btn-success'>Criar conta</button>"+
                "</div>"+
